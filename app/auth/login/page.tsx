    ...
    return (
        <>
            <div className="bg-white h-full fixed z-20 top-0 left-0 w-full">
               ...
               <div>
                <h3 className="font-bold pb-[12px] text-[#000000]w-[342px] h-[10px] text-[14px] leading-[100%]">WELCOME BACK</h3>
                <p className="text-[#00000099] pt-[12px] text-[12px] leading-[100%] W-[269px] h-[16px] font-normal">Sign in to access your account and track your style</p>
                <div className="flex flex-col py-[16px] my-[22px] gap-y-3 lg:flex-row lg:gap-x-5">
...
{/* form input & label */}
               <div className="py-[22px]">
                <form action="" className="flex flex-col gap-y-[24px] lg:gap-y-6">
                    {/* email */}
                    <div className="flex flex-col"><label htmlFor="Email" className="pb-[4px] text-[14px] font-normal leading-[100%]">Email address</label>
                    ...
                    {/* login button */}
                    <button className="bg-[#000000] text-[14px] text-[#ffffff] leading-[100%] font-medium rounded-[62px] px-[54px] py-[16px]">Login</button>
