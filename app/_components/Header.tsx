...
export default function Header() {
  ...
  return (
    <div className="fixed top-0 left-0 z-10 h-fit w-full flex items-center mx-auto max-w-[1440px] justify-between flex-col">
      {/* Dark header */}
      ...
      >
        <input
          className="w-full h-full border border-opacity-30 border-black rounded-[62px] mb-4 pl-12"
          type="text"
          placeholder="Search for products..."
        />
        <Image
